...
function handleResetPassword(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, userName, email, lastName;
        return __generator(this, function (_b) {
            try {
                ev.preventDefault();
                _a = ev.target.elements, userName = _a.userName, email = _a.email, lastName = _a.lastName;
                fetch("/api/users/reset-password", {
                    ...
                    if (data.error) {
                        ...
                        if (!containerPassword)
                            throw new Error("no found container password element");
