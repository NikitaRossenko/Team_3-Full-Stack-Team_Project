function game() {
    try {
            ...
            row.forEach((symbol, x) => {
                if (symbol === 1211) {
                    placementTowersArray.push(
                        new PlacementTower({
                            x: x * tileSize * mapSize,
                            y: y * tileSize * mapSize,
                        })
        ...
        function animate() {
            ...
            console.log("mousePos.x",mousePos.x + canvas.offsetLeft,"mousePos.y",mousePos.y + canvas.offsetTop, "this.position.x",placementTowersArray[0].position.x, "this.position.y",placementTowersArray[0].position.y)
        }
